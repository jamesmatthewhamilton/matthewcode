...
QUOTES = [
    ...
    "“Revere your power of judgment. On it alone depends that your mind forms no opinion at odds with nature.”\n"
    "— Marcus Aurelius, Meditations 3.9",

    "τὰ πράγματα οὐχ ἅπτεται τῆς ψυχῆς, ἀλλ᾽ ἔξω ἕστηκεν ἀτρεμοῦντα, αἱ δὲ ὀχλήσεις ἐκ μόνης τῆς ἔνδον ὑπολήψεως.\n"
